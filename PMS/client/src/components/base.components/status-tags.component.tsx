...
export function CompletedVariant1({ text }: { text?: string }) {
  return (
    <Box
      sx={{
        display: "flex",
    ...
    >
      <CheckCircleOutline
        sx={{ color: theme.status.completed, fontSize: "1.4rem" }}
      />
      {text ?? "Completed"}
    </Box>
  );
...
export function PendingVariant1({ text }: { text?: string }) {
  return (
    <Box
      sx={{
        display: "flex",
    ...
    >
      <HourglassEmpty
        sx={{ color: theme.status.pending, fontSize: "1.4rem" }}
      />
      {text ?? "Pending"}
    </Box>
  );
