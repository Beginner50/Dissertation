    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectSupervision", x => new { x.SupervisorID, x.StudentID, x.ProjectID });
                    table.ForeignKey(
                        name: "FK_ProjectSupervision_Projects_ProjectID",
                        column: x => x.ProjectID,
                        principalTable: "Projects",
                        principalColumn: "ProjectID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectSupervision_Users_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectSupervision_Users_SupervisorID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "admin@uni.com", false, "Admin", "$2a$12$FkZUs6elcp0MMrmAVvZXaud.SkwEG0JSQo0eQueIKmP63bHvbrK1m", "", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectSupervision_ProjectID",
                table: "ProjectSupervision",
                column: "ProjectID");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectSupervision_StudentID",
                table: "ProjectSupervision",
                column: "StudentID");
