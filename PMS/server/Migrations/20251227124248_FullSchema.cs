...
namespace PMS.Migrations
{
    ...
    public partial class FullSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tasks",
                columns: new[] { "ProjectTaskID", "AssignedDate", "Description", "DueDate", "ProjectID", "StagedDeliverableID", "StagingDeliverableID", "Status", "SubmittedDeliverableID", "Title" },
                values: new object[,]
                {
                    { 1L, new DateTime(2025, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Review current papers on Transformer models.", new DateTime(2025, 11, 15, 0, 0, 0, 0, DateTimeKind.Utc), 1L, null, null, "completed", null, "Literature Review" },
                    { 2L, new DateTime(2025, 11, 16, 0, 0, 0, 0, DateTimeKind.Utc), "Gather and clean the training dataset.", new DateTime(2025, 12, 10, 0, 0, 0, 0, DateTimeKind.Utc), 1L, null, null, "pending", null, "Dataset Collection" },
                    { 3L, new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Submit the formal research proposal.", new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Utc), 1L, null, null, "missing", null, "Proposal Submission" },
                    { 4L, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Compare Tesseract vs EasyOCR.", new DateTime(2025, 12, 15, 0, 0, 0, 0, DateTimeKind.Utc), 2L, null, null, "pending", null, "Algorithm Selection" },
                    { 5L, new DateTime(2025, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Develop a basic Python script for image-to-text conversion.", new DateTime(2025, 11, 20, 0, 0, 0, 0, DateTimeKind.Utc), 2L, null, null, "completed", null, "Initial Prototype" },
                    { 6L, new DateTime(2025, 12, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Architect the voting system contract in Solidity.", new DateTime(2025, 12, 20, 0, 0, 0, 0, DateTimeKind.Utc), 3L, null, null, "pending", null, "Smart Contract Design" }
                });
