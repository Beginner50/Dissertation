    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectAssignment", x => new { x.SupervisorID, x.StudentID, x.ProjectID });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectAssignment_Users_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectAssignment_Users_SupervisorID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignment_StudentID",
                table: "ProjectAssignment",
                column: "StudentID");
